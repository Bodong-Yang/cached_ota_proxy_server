...
class _App:
    ...
    async def _pull_data_and_send(self, url: str, send):
        """
        if cache is disabled, or cache is missed, 
        this method will be called.

        it will download the requested resources,
        and stream it to the client.

        when streaming, if cache is enabled, this method
        will also streams the contents to the ota cache module
        """
